...
String idUser = '1';
final String url = urlUsuarioXId + idUser ;
...
Future<Usuarios> fetchPost() async {
  try {
    ...
    logger.i('STATUSCODE: '+response.statusCode.toString());
    if (response.statusCode == 200) {
      logger.i('ResopnseBody: ' + response.body);
          ...
          child: FutureBuilder<Usuarios>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                controller: controllerEmail..text = data.email != null ? data.email : '', //TextEditingController(text: usuarios[i].email),//..text = usuarios[i].email,
                            ...
                            Container(
                              ...
                              child: TextField(
                                enabled: estadoInputs,
                                textAlign: TextAlign.center,
                                controller: controllerNombres..text = data.nombres != '' ? data.nombres : '',
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(),
                                  labelText: 'Nombres'
                                ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextField(
                                        enabled: estadoInputs,
                                        textAlign: TextAlign.center,
                                        controller: controllerApePat..text = data.apepat != '' ? data.apepat : '',
                                        decoration: InputDecoration(
                                          border: OutlineInputBorder(),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextField(
                                        enabled: estadoInputs,
                                        textAlign: TextAlign.center,
                                        controller: controllerApeMat..text = data.apemat != '' ? data.apemat : '',
                                        decoration: InputDecoration(
                                          border: OutlineInputBorder(),
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          enabled: estadoInputs,
                                          textAlign: TextAlign.center,
                                          controller: controllerDni..text = data.dni != '' ? data.dni : '',
                                          decoration: InputDecoration(
                                            border: OutlineInputBorder(),
                                            labelText: 'DNI'
                                          ),
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              children: <Widget>[
                                                ...
                                                color: Colors.white,
                                                label: Text( 
                                                  data.fec_nacimiento != '' && data.fec_nacimiento == null 
                                                    ? 
                                                  data.fec_nacimiento
                                                    :
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextField(
                                      enabled: estadoInputs,
                                      textAlign: TextAlign.center,
                                      controller: controllerNroMovil..text = data.nro_movil,
                                      decoration: InputDecoration(
                                        border: OutlineInputBorder(),
                ...
                return Text("${snapshot.error}", style: TextStyle(color: Colors.black, fontSize: 25));
              }
    ...
    try {
      ...
      FutureBuilder<Usuarios>(
        ...
        builder: (context, snapshot) {
          ...
          logger.i('snapshot has data: '+snapshot.hasData.toString());
          if (snapshot.hasData) {
            return Text(snapshot.data.nombres, style: TextStyle(color: Colors.black, fontSize: 25));
          } else if (snapshot.hasError) {
            return Text("${snapshot.error}", style: TextStyle(color: Colors.black, fontSize: 25));
          }
